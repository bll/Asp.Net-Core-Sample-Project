...
var routes = [
    { path: "", component: shop_component_1.Shop, pathMatch: 'full' },
    { path: "checkout", component: checkout_component_1.Checkout, pathMatch: 'full' },
    { path: "login", component: login_component_1.Login, pathMatch: 'full' }
];
